...
public class JavaIntegrationKit {
    ...
    public Map<String, String> hashCalMethod(HttpServletRequest request, HttpServletResponse response)
		...
		String key = "Q6hsrnOn";
        String salt = "AuXiuxeZ7G";
        String action1 = "";
        //String base_url = "https://sandboxsecure.payu.in";//Testing sandbox
        String base_url = "https://secure.payu.in";  // Production
        error = 0;
        String hashString = "";
        ...
        if (empty(params.get("hash")) && params.size() > 0) {
            if (empty(params.get("key")) || empty(txnid) || empty(params.get("amount")) || empty(params.get("firstname")) || empty(params.get("email")) 
            		|| empty(params.get("phone")) || empty(params.get("productinfo")) || empty(params.get("surl")) || empty(params.get("furl")) 
